...
/* Palm/webOS TLS extension compatibility structures */
typedef struct tls_extension_st {
    unsigned short type;
    unsigned short length;
    void *data;
} TLS_EXTENSION;

typedef int (*tls_extension_cb_fn)(SSL *s, TLS_EXTENSION *tls_ext, void *arg);
...
/* Palm/webOS TLS extension compatibility functions */
